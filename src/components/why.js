...
const What = ({handlePageChange, currentPage}) => {
    return(
        <div className='container'>
            ...
            <div className='logobox'>
                <h3 className="grayregularfont">
                    While popular social networks tackle this problem, such content gets lost in the vastness of these platforms among other things. <span className="coloredfont">Music</span> needs its own space.
                </h3>
                </div>  
